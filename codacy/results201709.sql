...
--
-- Name: result_partition_function_create_month_table(character varying); Type: FUNCTION; Schema: public; Owner: codacy
--
...
_endmonthstamp   TEXT;
BEGIN
--Takes the current inbound "timestamp" value and determines the year and month
_startmonthstamp := table_date;
_tablename := 'Result_Result_' || _startmonthstamp;
--Add the first day to make it a valid timestamp
...
--
-- Name: result_partition_function_generate_table(integer); Type: FUNCTION; Schema: public; Owner: codacy
--
...
--
-- Name: result_partition_function_insert(); Type: FUNCTION; Schema: public; Owner: codacy
--
...
--
-- Name: commitcomparison_id_seq; Type: SEQUENCE; Schema: public; Owner: codacy
--

CREATE SEQUENCE public.commitcomparison_id_seq
    START WITH 13000000000
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
...
--
-- Name: CommitComparison; Type: TABLE; Schema: public; Owner: codacy
--
...
--
-- Name: resultoverview_deltaoverview_id_seq; Type: SEQUENCE; Schema: public; Owner: codacy
--
...
--
-- Name: ResultOverview_DeltaOverview; Type: TABLE; Schema: public; Owner: codacy
--
...
--
-- Name: resultoverview_resultoverview_id_seq; Type: SEQUENCE; Schema: public; Owner: codacy
--
...
--
-- Name: ResultOverview_ResultOverview; Type: TABLE; Schema: public; Owner: codacy
--
...
--
-- Name: result_result_id_seq; Type: SEQUENCE; Schema: public; Owner: codacy
--

CREATE SEQUENCE public.result_result_id_seq
    START WITH 1300000000000
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
...
--
-- Name: Result_Result; Type: TABLE; Schema: public; Owner: codacy
--

CREATE TABLE public."Result_Result" (
    id bigint DEFAULT nextval('public.result_result_id_seq'::regclass) NOT NULL,
    "commitId" bigint NOT NULL,
...
--
-- Name: result_resultdata_id_seq; Type: SEQUENCE; Schema: public; Owner: codacy
--

CREATE SEQUENCE public.result_resultdata_id_seq
    START WITH 130000000000
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
...
--
-- Name: Result_ResultData; Type: TABLE; Schema: public; Owner: codacy
--
...
--
-- Name: result_resultmetadata_id_seq; Type: SEQUENCE; Schema: public; Owner: codacy
--
...
--
-- Name: Result_ResultMetadata; Type: TABLE; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_2019-10; Type: TABLE; Schema: public; Owner: codacy
--

CREATE TABLE public."Result_Result_2019-10" (
    CONSTRAINT "Result_Result_2019-10_timestamp_check" CHECK ((("timestamp" >= '2019-10-01 00:00:00'::timestamp without time zone) AND ("timestamp" < '2019-11-01 00:00:00'::timestamp without time zone)))
)
INHERITS (public."Result_Result");


ALTER TABLE public."Result_Result_2019-10" OWNER TO codacy;

--
-- Name: Result_Result_2019-11; Type: TABLE; Schema: public; Owner: codacy
--

CREATE TABLE public."Result_Result_2019-11" (
    CONSTRAINT "Result_Result_2019-11_timestamp_check" CHECK ((("timestamp" >= '2019-11-01 00:00:00'::timestamp without time zone) AND ("timestamp" < '2019-12-01 00:00:00'::timestamp without time zone)))
)
INHERITS (public."Result_Result");


ALTER TABLE public."Result_Result_2019-11" OWNER TO codacy;

--
-- Name: Result_Result_Old; Type: TABLE; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_2019-10 id; Type: DEFAULT; Schema: public; Owner: codacy
--

ALTER TABLE ONLY public."Result_Result_2019-10" ALTER COLUMN id SET DEFAULT nextval('public.result_result_id_seq'::regclass);


--
-- Name: Result_Result_2019-11 id; Type: DEFAULT; Schema: public; Owner: codacy
--

ALTER TABLE ONLY public."Result_Result_2019-11" ALTER COLUMN id SET DEFAULT nextval('public.result_result_id_seq'::regclass);


--
-- Name: Result_Result_Old id; Type: DEFAULT; Schema: public; Owner: codacy
--

ALTER TABLE ONLY public."Result_Result_Old" ALTER COLUMN id SET DEFAULT nextval('public.result_result_id_seq'::regclass);


--
-- Name: CommitComparison CommitComparison_pkey; Type: CONSTRAINT; Schema: public; Owner: codacy
--
...
--
-- Name: ResultOverview_DeltaOverview ResultOverview_DeltaOverview_pkey; Type: CONSTRAINT; Schema: public; Owner: codacy
--
...
--
-- Name: ResultOverview_ResultOverview ResultOverview_ResultOverview_pkey; Type: CONSTRAINT; Schema: public; Owner: codacy
--
...
--
-- Name: Result_ResultData Result_ResultData_pkey; Type: CONSTRAINT; Schema: public; Owner: codacy
--
...
--
-- Name: Result_ResultMetadata Result_ResultMetadata_pkey; Type: CONSTRAINT; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result Result_Result_pkey; Type: CONSTRAINT; Schema: public; Owner: codacy
--
...
--
-- Name: CommitComparison_destCommitId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: CommitComparison_resultId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: CommitComparison_srcCommitId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: CommitComparison_srcCommitId_destCommitId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: DeltaOverview_commitId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: DeltaOverview_resultId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: ResultData_fileDataId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: ResultData_patternId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: ResultData_projectId_uuid_key; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: ResultMetadata_blameCommitId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: ResultMetadata_projectId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: ResultOverview_commitId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: ResultOverview_patternId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_ResultMetadata_authorId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_ResultMetadata_resultDataId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_2019-10_commitId; Type: INDEX; Schema: public; Owner: codacy
--

CREATE INDEX "Result_Result_2019-10_commitId" ON public."Result_Result_2019-10" USING btree ("commitId");


--
-- Name: Result_Result_2019-10_fileId; Type: INDEX; Schema: public; Owner: codacy
--

CREATE INDEX "Result_Result_2019-10_fileId" ON public."Result_Result_2019-10" USING btree ("fileId");


--
-- Name: Result_Result_2019-10_resultDataId; Type: INDEX; Schema: public; Owner: codacy
--

CREATE INDEX "Result_Result_2019-10_resultDataId" ON public."Result_Result_2019-10" USING btree ("resultDataId");


--
-- Name: Result_Result_2019-10_resultOverviewId; Type: INDEX; Schema: public; Owner: codacy
--

CREATE INDEX "Result_Result_2019-10_resultOverviewId" ON public."Result_Result_2019-10" USING btree ("resultOverviewId");


--
-- Name: Result_Result_2019-10_timestamp_id; Type: INDEX; Schema: public; Owner: codacy
--

CREATE INDEX "Result_Result_2019-10_timestamp_id" ON public."Result_Result_2019-10" USING btree ("timestamp", id);


--
-- Name: Result_Result_2019-11_commitId; Type: INDEX; Schema: public; Owner: codacy
--

CREATE INDEX "Result_Result_2019-11_commitId" ON public."Result_Result_2019-11" USING btree ("commitId");


--
-- Name: Result_Result_2019-11_fileId; Type: INDEX; Schema: public; Owner: codacy
--

CREATE INDEX "Result_Result_2019-11_fileId" ON public."Result_Result_2019-11" USING btree ("fileId");


--
-- Name: Result_Result_2019-11_resultDataId; Type: INDEX; Schema: public; Owner: codacy
--

CREATE INDEX "Result_Result_2019-11_resultDataId" ON public."Result_Result_2019-11" USING btree ("resultDataId");


--
-- Name: Result_Result_2019-11_resultOverviewId; Type: INDEX; Schema: public; Owner: codacy
--

CREATE INDEX "Result_Result_2019-11_resultOverviewId" ON public."Result_Result_2019-11" USING btree ("resultOverviewId");


--
-- Name: Result_Result_2019-11_timestamp_id; Type: INDEX; Schema: public; Owner: codacy
--

CREATE INDEX "Result_Result_2019-11_timestamp_id" ON public."Result_Result_2019-11" USING btree ("timestamp", id);


--
-- Name: Result_Result_Old_commitId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_Old_fileId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_Old_resultDataId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_Old_resultOverviewId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_Old_timestamp_id; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_commitId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_fileId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_resultDataId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_resultOverviewId; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_timestamp_id; Type: INDEX; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result result_result_partition_trigger_insert; Type: TRIGGER; Schema: public; Owner: codacy
--
...
--
-- Name: Result_ResultMetadata Result_ResultMetadata_resultDataId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_2019-10 Result_Result_2019-10_resultDataId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: codacy
--

ALTER TABLE ONLY public."Result_Result_2019-10"
    ADD CONSTRAINT "Result_Result_2019-10_resultDataId_fkey" FOREIGN KEY ("resultDataId") REFERENCES public."Result_ResultData"(id) ON DELETE CASCADE;


--
-- Name: Result_Result_2019-10 Result_Result_2019-10_resultOverviewId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: codacy
--

ALTER TABLE ONLY public."Result_Result_2019-10"
    ADD CONSTRAINT "Result_Result_2019-10_resultOverviewId_fkey" FOREIGN KEY ("resultOverviewId") REFERENCES public."ResultOverview_ResultOverview"(id) ON DELETE CASCADE;


--
-- Name: Result_Result_2019-11 Result_Result_2019-11_resultDataId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: codacy
--

ALTER TABLE ONLY public."Result_Result_2019-11"
    ADD CONSTRAINT "Result_Result_2019-11_resultDataId_fkey" FOREIGN KEY ("resultDataId") REFERENCES public."Result_ResultData"(id) ON DELETE CASCADE;


--
-- Name: Result_Result_2019-11 Result_Result_2019-11_resultOverviewId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: codacy
--

ALTER TABLE ONLY public."Result_Result_2019-11"
    ADD CONSTRAINT "Result_Result_2019-11_resultOverviewId_fkey" FOREIGN KEY ("resultOverviewId") REFERENCES public."ResultOverview_ResultOverview"(id) ON DELETE CASCADE;


--
-- Name: Result_Result_Old Result_Result_Old_resultDataId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result_Old Result_Result_Old_resultOverviewId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result Result_Result_resultDataId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: codacy
--
...
--
-- Name: Result_Result Result_Result_resultOverviewId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: codacy
--
