...
| Staging      | codacy-doks-cluster-dev     | codacy-staging    | Updated automatically on each component pipeline. Rolling release of [stable](https://charts.codacy.com/stable/api)     | <http://staging.k8s.dev.codacy.org>    |
