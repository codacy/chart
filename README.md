...
| `global.github.app.appId`                       | App id used in Codacy to integrate with GitHub Apps                                                          | `nil`           |
...
| `global.githubEnterprise.app.appId`             | App id used in Codacy to integrate with GitHub Apps in GitHub Enterprise                                     | `nil`           |
