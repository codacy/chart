...
-   [ ] 5.  Generate release notes
    ...
    This will update the `docs/releasenotes.md` file. It may be necessary to manually curate this file. Get all the necessary stakeholders involved in this process before checking in any changes.
...
-   [ ] 6.  Commit the updated `docs/releasenotes.md`, `requirements.lock` and `./codacy/values.yaml` to the branch
...
-   [ ] 7.  Tag the commit with a release candidate version following the pattern `x.x.x-RC-0`
